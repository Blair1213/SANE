...
KG_FILE = {
           ...
           'kegg':os.path.join(RAW_DATA_DIR,'kegg','train2id.txt'),
            ...
            'hdvd':os.path.join(RAW_DATA_DIR,'HDVD','train2id.txt')}
ENTITY2ID_FILE = {
                    ...
                    'hdvd':os.path.join(RAW_DATA_DIR,'HDVD','entity2id.txt')}
EXAMPLE_FILE = {
               ...
               'kegg':os.path.join(RAW_DATA_DIR,'kegg','approved_example.txt'),
                ...
                'hdvd':os.path.join(RAW_DATA_DIR,'HDVD','approved_example.txt')}
SEPARATOR = {'drug':'\t','kegg':'\t','ogb':' ','hdvd':' '}
THRESHOLD = {'drug':4,'kegg':4,'ogb':4,'hdvd':4} #添加drug修改
NEIGHBOR_SIZE = {'drug':4,'kegg':4,'ogb':4,'hdvd':5}
...
DRUG_SMILE_TEMPLATE = 'HDVD_id_smile.npy'
SMILE_HASH = 'HDVD_smile_hash.npy'
VIRUS_SEQUENCE_TEMPLATE = "HDVD_id_virus_sequence.npy"
VIRUS_HASH = "HDVD_sequence_hash.npy"
...
RESULT_LOG={'drugbank':'drugbank_result.txt','kegg':'kegg_result.txt','ogb':'ogb_result.txt','hdvd':'hdvd_result.txt'}
...
class ModelConfig(object):
    def __init__(self):
        ...
        self.virus_hash = None
        self.entity_hash = None
